...
[작성 규칙]
1. 반드시 기승전결 4단계 구조로 작성
2. 각 단계는 2-3문장, 총 8-12문장
3. ${guide.style}
4. ${guide.tone}
5. 구연동화체 절대 금지 ("~답니다", "~였단다", "~했지요" 등)

[필수 출력 형식 - 반드시 이 형식을 따르세요]

[기]
주인공과 배경을 소개하는 2-3문장. 이야기가 시작되는 상황을 제시합니다.

[승]
사건이 전개되는 2-3문장. 주인공이 행동하고 상황이 발전합니다.

[전]
갈등이 심화되는 2-3문장. 위기나 어려움이 등장합니다.

[결]
문제가 해결되는 2-3문장. 이야기의 결말과 변화를 보여줍니다.

중요: [기], [승], [전], [결] 태그를 각 단계 앞에 반드시 써주세요.
다른 텍스트(제목, 설명 등)는 절대 포함하지 마세요.`;
