          ...
          >
            <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: "14px", color: "#666", lineHeight: "1.6", marginBottom: "0" }}>
                  만든 굿즈를 판매하거나, 승화전사·굿즈 제작
                  <br />
                  기술을 공방 창업·강의 프로그램으로 확장할 수 있어요.
                </p>
                <p style={{
                  marginTop: "12px",
                  fontSize: "12px",
          ...
          >
            <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: "14px", color: "#666", lineHeight: "1.6", marginBottom: "0" }}>
                  작품을 모아 디지털 앨범·슬라이드북·온라인 전시관으로 만들고
                  <br />
