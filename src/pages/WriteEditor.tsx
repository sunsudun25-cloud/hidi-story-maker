...
1. **짧고 간결한 문장으로 2~3개 작성**
   - 한 문장은 15-20자 내외
   - 불필요한 수식어 제거
   - 예: "새 우산을 두고 그것을 든다. 무겁다." (O)

2. **감정을 직접 말하지 말고 보여주기 (Show, don't tell)**
   - 감정 단어 절대 사용 금지: "설레는", "그리운", "슬픈", "기쁜", "외로운" 등
   - 대신 구체적인 행동이나 사물로 감정 표현
   - 예: "비가 오면 그 우산을 든다." (O)
   - 예: "비가 오면 그리운 마음에 그 우산을 든다." (X)

3. **구체적인 사물과 행동 중심**
   - 눈에 보이는 것, 손으로 만질 수 있는 것
   - 추상적 표현 최소화

4. **절대 금지 표현:**
   - "~한 마음으로", "~한 느낌이 들었다"
   - "설레는", "행복한", "슬픈" 같은 감정 형용사
   - "~깨달았다", "~알게 되었다"
   - 구연동화체: "~습니다", "~했지요", "~였단다"
...
**참고 스타일 (이런 식으로):**
"비가 오는 날이면 나는 새 우산을 두고 그것을 들고 나간다. 무겁다. 그래도 그 무게가 싫지 않다."

위 수필에 자연스럽게 이어질 2~3개의 짧은 문장을 작성해주세요.
` : `
다음은 사용자가 작성 중인 글입니다:
