...
1. **짧고 간결한 문장 사용**
   ...
   - 불필요한 수식어 제거
   - 예: "현관 구석에 우산이 있다." (O)
   - 예: "현관 구석에는 아버지의 낡은 우산이 쓸쓸하게 놓여 있었다." (X)

2. **감정을 직접 말하지 말고 보여주기 (Show, don't tell)**
   - 감정 단어 사용 금지: "설레는", "슬픈", "기쁜", "그리운", "외로운" 등
   - 대신 구체적인 행동이나 사물로 감정 암시
...
4. **구체적인 사물과 행동으로 표현**
   - 추상적 표현 최소화
   - 손으로 만질 수 있는 것, 눈으로 볼 수 있는 것 중심
   - 예: "손잡이가 닳아서 검은 테이프가 둘려 있다." (O)

5. **절대 금지 표현:**
   - "~한 마음으로", "~한 느낌이 들었다"
   - "설레는", "행복한", "슬픈" 같은 감정 형용사
   - "~깨달았다", "~알게 되었다" 같은 직접적 깨달음 표현
   - 구연동화체: "~답니다", "~였단다", "~했지요"
...
사람은 떠나도 물건은 남는다는 게 이상하다고 생각했는데, 이제는 그게 고맙다."
