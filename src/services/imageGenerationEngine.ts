...
function buildScenePrompt(request: MasterImageRequest): string {
  ...
  const intervieweeMap: Record<string, string> = {
    ...
    boyChild: "Korean elementary school boy student, MUST look exactly 8 years old (ABSOLUTELY NOT 12+, NOT teenager, NOT young adult), extremely short child height (120cm tall, much shorter than adult), very round chubby innocent child face, baby face features, short messy black hair, very big round innocent eyes, wide cheerful child smile showing baby teeth, wearing colorful children's t-shirt with cartoon character and denim shorts, visibly small child body with short arms and legs, child proportions (head larger relative to body), both hands and arms completely visible outside at sides, small child hands, NEVER EVER hands in pockets or behind back",
    girlChild: "Korean elementary school girl student, MUST look exactly 8 years old (ABSOLUTELY NOT 12+, NOT teenager, NOT young adult), extremely short child height (120cm tall, much shorter than adult), very round chubby innocent child face, baby face features, short black hair with cute hair clips or ponytail, very big round innocent eyes, wide cheerful child smile showing baby teeth, wearing colorful children's dress or t-shirt with skirt, visibly small child body with short arms and legs, child proportions (head larger relative to body), both hands and arms completely visible outside at sides, small child hands, NEVER EVER hands in pockets or behind back",
